...
class MaterialUnholdPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _MaterialUnholdPageState();
  }  
}

class _MaterialUnholdPageState extends State<MaterialUnholdPage> {
  ...
  void _realConfirmationAction(List selectedItems) {
    ...
    HttpDigger().postWithUri("LoadPlanProcess/UnLockTag", parameters: mDict, success: (int code, String message, dynamic responseJson) {
      print("LoadPlanProcess/UnLockTag: $responseJson");
      if (code == 0) {
        HudTool.showInfoWithStatus(message);
        return;
      }
