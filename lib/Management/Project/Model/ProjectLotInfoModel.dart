...
part 'ProjectLotInfoModel.g.dart';


@JsonSerializable()
  class ProjectLotInfoModel extends Object {
  ...
  ProjectLotInfoModel(this.LOTSize,this.StatusDesc,this.HoldDesc,this.CTime,this.OTime,this.LevelManage,this.ProdClassCode,this.LotNo,this.Status,this.Hold,this.HoldCode,this.ProcessCode,this.ProcessName,this.ItemCode,this.ItemName,this.Dscb,this.Qty,this.Cost,this.CToolNo,this.Wono,this.OrderNo,this.Grade,this.LineCode,this.LineName,this.WorkCenterCode,this.WorkCenterName,this.Barcode,this.Delflag,this.CreateTime,this.ModifiedTime,this.Comment,this.DataGroup,);

  factory ProjectLotInfoModel.fromJson(Map<String, dynamic> srcJson) => _$ProjectLotInfoModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$ProjectLotInfoModelToJson(this);
