...
part 'ProjectLotLockItemModel.g.dart';


@JsonSerializable()
  class ProjectLotLockItemModel extends Object {
  ...
  ProjectLotLockItemModel(this.ID,this.LotNo,this.Status,this.StatusDesc,this.Hold,this.HoldCode,this.ProcessCode,this.ProcessName,this.ItemCode,this.ItemName,this.Dscb,this.Qty,this.Cost,this.CToolNo,this.FlowCode,this.FlowName,this.Wono,this.OrderNo,this.Grade,this.Location,this.RepairCode,this.ScrapCode,this.FromLot,this.IntoLot,this.LineCode,this.LineName,this.WorkCenterCode,this.WorkCenterName,this.Delflag,this.CreateTime,this.Creator,this.ModifiedTime,this.Modifier,this.Comment,this.RowVersion,);

  factory ProjectLotLockItemModel.fromJson(Map<String, dynamic> srcJson) => _$ProjectLotLockItemModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$ProjectLotLockItemModelToJson(this);
