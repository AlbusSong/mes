...
part of 'ProjectReturnRepairmentCurrentDayProjectModel.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ProjectReturnRepairmentCurrentDayProjectModel
    _$ProjectReturnRepairmentCurrentDayProjectModelFromJson(
        Map<String, dynamic> json) {
  return ProjectReturnRepairmentCurrentDayProjectModel(
...
Map<String, dynamic> _$ProjectReturnRepairmentCurrentDayProjectModelToJson(
        ProjectReturnRepairmentCurrentDayProjectModel instance) =>
    <String, dynamic>{
