...
part of 'ProjectLotUnlockItemModel.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ProjectLotUnlockItemModel _$ProjectLotUnlockItemModelFromJson(
    Map<String, dynamic> json) {
  return ProjectLotUnlockItemModel(
    json['ID'] as int,
...
Map<String, dynamic> _$ProjectLotUnlockItemModelToJson(
        ProjectLotUnlockItemModel instance) =>
    <String, dynamic>{
      'ID': instance.ID,
